...
<div class="col-sm-3" align="center">
    <div class="card mb-4 me-4" style="width: 19rem;">
        ...
        <div class="card-body ">
            ...
            เหลือ <?php echo $row_prd["p_qty"];?> <?php echo $row_prd["p_unit"];?>
            <br><br>
            <button type="button" class="btn btn-dark"><a href="prd.php?id=<?php echo $row_prd[0]; ?>" class="link-body-emphasis text-light"> รายละเอียดสินค้า </a></button>
        </div>
    </div>
</div>
<?php } ?>