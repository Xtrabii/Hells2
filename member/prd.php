    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="container" style="margin-top: 50px">
          <div class="row">
            <div class="col-md-6">
                <?php echo"<img src='../p_img/".$row['p_img']."'width='600px'>";?>
            </div>
            <div class="col-md-6">
              <br>
              ...
              <p>
                ...
                เหลือ :<b> <?php echo $row["p_qty"];?> </b> <?php echo $row["p_unit"];?>
              </p>
              <?php echo $row["p_detail"];?>
                 <br>ยอดการเข้าชม <?php echo $row['p_view']; ?> ครั้ง
                 <br><br><br><br><br>
                 <a href="index.php" class="btn btn-dark btn-lg link-body-emphasis text-light"> back </a>
                 <a href="order.php?id=<?=$row['p_id']?>" class="btn btn-info btn-lg link-body-emphasis text-light"> add cart </a>
