...
<nav class="sticky-top bg-body-tertiary p-3 mb-3 border-bottom infobg">
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <!-- cart -->
      <div class="">
        <div class="nav-profile-cart me-4">
            <a href="cart.php" class="link-body-emphasis"><i class="fas fa-cart-shopping"> Cart</i></a>
          <div id="countcart" class="countcart" style="display: none;">
          </div>
        </div>
      </div>
      ...
      <div class="dropdown text-end">
        <a href="#" class="col-2 d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="../m_img/<?php echo $m_img; ?>" alt="mdo" width="32" height="32" class="rounded-circle">
        </a>
        <ul class="dropdown-menu text-small">
          <li><a class="dropdown-item" href="#"><?php echo $m_name; ?></a></li>
